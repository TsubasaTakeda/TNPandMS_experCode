...
def LOGIT_TNPandMS_PL(veh_info, user_info, TNP_capa, temp_info, output_root):
    ...
    veh_pl = msa.PL()
    veh_pl.set_x_init(init_sol)
    veh_pl.set_obj_func(obj_func)
    veh_pl.set_dir_func(dir_func)
    veh_pl.set_conv_judge(0.1)
    veh_pl.set_output_iter(1)
    veh_pl.set_output_root(output_root)
    veh_pl.exect_PL()
    ...
    # print('sol: ', fista.sol)
    print('sol_obj: ', veh_pl.sol_obj)
    print('iteration: ', veh_pl.iter)
    print('pararel_time: ', veh_pl.para_time)
    print('total_time: ', veh_pl.total_time)
    print('num_call_obj: ', veh_pl.num_call_obj)
    print('num_call_dir: ', veh_pl.num_call_dir)
    # print('output_data: ')
    # print(fista.output_data)
...
if __name__ == '__main__':
    ...
    for scene in scenarios:
        ...
        LOGIT_TNPandMS_PL(veh_info, user_info, TNP_capa, temp_info, output_root)
